    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Uneli ste pogrešne podatke, pokušajte ponovo");
                    return View(model);
            }
        }
        ...
        public ActionResult Edit()
        {
            ...
            ApplicationUser applicationUser = _context.Users.Find(user);
            if (applicationUser == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        public ActionResult SetRating(string userId, int rank)
        {
            var rater = User.Identity.GetUserId();
            var rate = _context.UserRatings.SingleOrDefault(ssf => ssf.UserId == userId && ssf.RaterId == rater);
            if (rate != null)
            ...
            rating.User = _context.Users.Find(userId);
